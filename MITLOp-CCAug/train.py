...
import trainers.dcls
import trainers.mitlop
...
def extend_cfg(cfg):
    ...
    cfg.TRAINER.COOP.VP_LENGTH = 8
    cfg.TRAINER.COOP.PROMPT_DEPTH = 10
    cfg.TRAINER.COOP.AUGMENT = "color"
...
def main(args):
    ...
    if not args.no_train:
        if args.hybrid:
            print("prompt learning after class name learning")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--hybrid",
                        action="store_true",
                        help="prompt learning after class name learning")
    parser.add_argument(
        "opts",
        default=None,
